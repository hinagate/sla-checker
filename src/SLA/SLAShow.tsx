...
import { useGetOne, useRedirect, Title,useNotify,Form, Labeled,NumberField,useRecordContext,TextField,TextInput,SimpleForm,Show,Edit,Create,ReferenceInput,RecordContextProvider } from 'react-admin';
...
<Grid item xs={6} sm={12} md={6}>
    ...
    {/* <ReferenceInput source="SLA_NO" reference="SLA_item" target="SLA_NO">
    <TextInput source="Parts_Ceiliing"></TextInput>
            </ReferenceInput> */}
</Grid>
           </Card>
