...
export default {
    ...
    VRN: [  
        {
            ...
            Make:'TOYOTA',
            Model: 'ALPHARD 350',
            Type:'MULTI_PURPOSE VEHICLE',
            SLA_NO: '400215',
            SLA_Start:'2022/03/27',
            SLA_END:'2028/06/30',
            Parts_Ceiliing: '$2800',
            Availiability:'92%',
            PM:'True',
            ...
            FA: 'True',
            jobs_Included:['PM','CM'],
            Service_Included:['Supernumerary'],
            Equipment_Included:['Fire_Extinguisher'],
            Collect_n_Delivery:'False',
            Resident_staff:'False',
            Fire_Extinguisher: 'True',
            Sep_Chargefor_aged:'True',
            Salary_Adjust:'True',
            Supernumerary:'True',
            Others:''
            },
    ...
    actionboard: [
        ...
        },
        {
            ...
            "Classification" : "VIP",
            "Dept"  :  "商務及經濟發展局",
            "Post" : "商務及經濟發展局常任秘書長 (通訊及創意產業)",
            "Chki" : "2022/03/27 23:05:00",
            "AlertLevel" : "Orange",
            "activity":"",
            "Status":"Active"
...
cs_record: [
    {
        id: 1,
        author: 'MIMV',
        contacted_at: '2022-04-26 10:26:14',
        customer_name:'Miss Wong',
        post_title:'Chief Secretary',
        tel:'37576223',
        notes:"Call to Chief Executive's secretary, noted her AM90 will be available for picked up on 27/04/2022 ",
        post_id: 1,
    },
    {
        id: 2,
    ...
    },
    {
        id: 3,
        author: 'AMIMV',
        contacted_at: '2022-04-25 17:26:14',
        customer_name:'Miss Wong',
        post_title:'Chief Secretary',
        tel:'37576223',
        notes:"Chief Executive's secretary had called and ask if the vehicle could be return in 2 days.  ",
        post_id: 1,
    },
],
...
//     "DEPT":"ICAC",
//       "Manufacturer":"MAZDA",
//       "MODEL/Type":"BIANTE 2.0",
//       "Vehicle Class":"Medium Van",
//       "Dealer Name":"VANG IEK MOTORS (HK) LIMITED",
//       "Dealer Phone": "3971-0251",
//       "VRN":"AM2813",
//       "equipment_number":"30029240",
// 	  "Progress": [1, 4],
//       "Subject": "更換動力輔助轉向機螺絲",
//       "Description": "廠房發現部分處於嚴寒地區之Model S，其動力輔助轉向機螺絲因當地需頻繁使用含鈣或鎂成分的溶雪鹽劑，引至出現被侵蝕的情況。",
//       "Remedial Actoin" : "為免受影響車輛有可能在日後於高侵蝕性的環境中駕駛，廠方決定為全球所有早期生產的Model S 更換動力輔助轉向機螺絲。",
//       "Build Dates":"2012-05-31",
//       "Launch Date":"2018-04-01",
//       "Tentative Date of Recall Completion":"2019-04-01",
//       "Notification to GLD": "2019-06-01",
//       "Actual Date of Recall Completion": "" ,
...
//     "DEPT":"WSD",
//       "Manufacturer":"TOYOTA",
//       "MODEL/Type":"HIACE TRH201R-SSMDK",
//       "Vehicle Class":"Medium Van",
//       "Dealer Name":"CROWN MOTORS LIMITED",
//       "Dealer Phone": "3971-0251",
//       "VRN":"AM2560",
//       "equipment_number":"30022315",
//       "Progress": [1, 2 , 3 ,4],
//       "Subject": "更換動力輔助轉向機螺絲",
//       "Description": "廠房發現部分處於嚴寒地區之Model S，其動力輔助轉向機螺絲因當地需頻繁使用含鈣或鎂成分的溶雪鹽劑，引至出現被侵蝕的情況。",
//       "Remedial Actoin" : "為免受影響車輛有可能在日後於高侵蝕性的環境中駕駛，廠方決定為全球所有早期生產的Model S 更換動力輔助轉向機螺絲。",
//       "Build Dates":"2012-07-31",
//       "Launch Date":"2018-07-01",
//       "Tentative Date of Recall Completion":"2019-07-01",
//       "Notification to GLD": "2019-06-01",
//       "Actual Date of Recall Completion": "" ,
...
//     "DEPT":"HKPF",
//       "Manufacturer":"TOYOTA",
//       "MODEL/Type":"PRIUS ZVW30R-AHXEBW",
//       "Vehicle Class":"Small\/Medium Saloon",
//       "Dealer Name":"CROWN MOTORS LIMITED",
//       "Dealer Phone": "3971-0251",
//       "VRN":"AM7969",
//       "equipment_number":"30021286",
//       "Progress": [1],
//       "Subject": "更換動力輔助轉向機螺絲",
//       "Description": "廠房發現部分處於嚴寒地區之Model S，其動力輔助轉向機螺絲因當地需頻繁使用含鈣或鎂成分的溶雪鹽劑，引至出現被侵蝕的情況。",
//       "Remedial Actoin" : "為免受影響車輛有可能在日後於高侵蝕性的環境中駕駛，廠方決定為全球所有早期生產的Model S 更換動力輔助轉向機螺絲。",
//       "Build Dates":"2013-03-31",
//       "Launch Date":"2018-09-01",
//       "Tentative Date of Recall Completion":"2018-01-01",
//       "Notification to GLD": "2019-06-01",
//       "Actual Date of Recall Completion": "", 
...
//         {
//             id: 1,
//             name: { en: 'Recall Creation' },
          
//             //published: 1,
//         },
//         {
//             id: 2,
//             name: { en: 'Notification to GLD' },
//             //published: false,
//         },
//         {
//             id: 3,
//             name: { en: 'Pending Recall' },
//             //published: true,
//         },
//         {
//             id: 4,
//             name: { en: 'Recall Completed' },
//             //published: false,
//         },
